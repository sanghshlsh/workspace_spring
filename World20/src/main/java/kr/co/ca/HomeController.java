...
public class HomeController {
	...
	public void test5(@ModelAttribute("str2") String mm) { //@ModelAttribute("str2") 하면 여기서 곧바로 사용가능,jsp 에서도 바로 가능   
	//String str2, Model model {  System.out.println(str2);}->null 나옴 
